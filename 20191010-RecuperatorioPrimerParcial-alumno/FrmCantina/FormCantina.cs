    ...
    public partial class FormCantina : Form
    {
        ...
        public string GetInforme
        {
            get
            {
                ...
                foreach (Botella bottle in this.barra.Cantina.Botellas)
                {
                    if (bottle is Agua)
                    {
                        cadenaInforme.AppendFormat();
                    }
                    else if (bottle is Cerveza)
                    {
                        cadenaInforme.AppendFormat();
                    }
                    return cadenaInforme.ToString();
                }
            }
        }
        /// <summary>
        ...
        private void FormCantina_FormClosing(object sender, FormClosingEventArgs e)
        {

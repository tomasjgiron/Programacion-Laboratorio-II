        ...
        private void btnLlamar_Click(object sender, EventArgs e)
        {
            ...
            if(txtDestino.Text != "Nro Destino" && txtOrigen.Text != "Nro Origen")
            {
                if (txtDestino.Text.StartsWith("#"))
                {
                    ...
                    call = new Provincial(txtOrigen.Text, franjas, (float)randomDuracion, txtDestino.Text);
                }
                else
                {
                    int randomCosto = num.Next(5, 56);
                    float costoFloat = randomCosto / 10;
                    call = new Local(txtOrigen.Text, costoFloat, txtDestino.Text, (float)randomDuracion);
                }
                try
                {
                    central += call;
                    MessageBox.Show("Llamada creada exitosamente");
                }
            ...
            {
                MessageBox.Show("Error. Ingresar una llamada");
            }
